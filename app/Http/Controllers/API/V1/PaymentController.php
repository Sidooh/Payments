    ...
    public function show(Payment $payment): JsonResponse
    {
        ...
        if ($payment->subtype === PaymentSubtype::B2B->name) {
            $payment->load([
                ...
                'provider.callback:id,initiator_reference,response_code,status,status_description,amount,account_reference,confirmation_code,receiver_party_name,created_at',
            ]);
        }
